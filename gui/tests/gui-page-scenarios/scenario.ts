...
const visualRee = {
    ...
    subject: {
      ...
      receipts: {
        ...
        build: {
          schema_version: 1,
          run_id: "run-build",
          started_at: "2026-04-12T09:31:10Z",
          finished_at: "2026-04-12T09:32:42Z",
          duration_ms: 92000,
          recorded_at: "2026-04-12T09:32:42Z",
          operation: "build_runtime",
          snapshot_digest: "sha256:source-snapshot",
          build_runtime_script_path: "overlay/build.sh",
          build_runtime_script_digest: "sha256:build-script",
          workspace_drift: { status: "clean", changed_path_count: 0 },
          runtime_path: "artifacts/climate-runtime.tar",
          produced_runtime_digest: "sha256:runtime",
        },
        test_activation: {
          schema_version: 1,
          run_id: "run-activation",
          started_at: "2026-04-12T09:35:00Z",
          finished_at: "2026-04-12T09:35:07Z",
          duration_ms: 7000,
          recorded_at: "2026-04-12T09:35:07Z",
        ...
        experiments: {
          "regional-forecast": {
            schema_version: 1,
            run_id: "run-regional-forecast",
            started_at: "2026-04-12T09:36:00Z",
            finished_at: "2026-04-12T09:36:18Z",
            duration_ms: 18000,
            recorded_at: "2026-04-12T09:36:18Z",
            ...
            run_exit_code: 0,
            verify_exit_code: 0,
            produced_output_digest: "sha256:forecast-output",
          },
        },
      },
      contents: { entries: [] },
  ...
  ree_files: [
    ...
    {
      path: "overlay/experiments/regional-forecast.sh",
      kind: "ree",
      tag: "Overlay",
      size: 286,
      content: "#!/bin/sh\npython -m climate_model.forecast\n",
    },
    {
      path: "overlay/experiments/regional-forecast-verify.sh",
      kind: "ree",
      tag: "Overlay",
      size: 102,
      content: "#!/bin/sh\ntest -f results/forecast.csv\n",
    },
    {
