...
export const Ic = {
  ...
  github: (s = 15) => (
    <Svg
      size={s}
      d="M15 22v-4a4.8 4.8 0 00-1-3.5c3.3-.4 6.8-1.6 6.8-7A5.4 5.4 0 0019.3 4 5 5 0 0019.2.5S18 0 15 2a13.4 13.4 0 00-7 0C5 .1 3.8.5 3.8.5A5 5 0 003.7 4a5.4 5.4 0 00-1.5 3.7c0 5.3 3.5 6.5 6.8 6.9a4.8 4.8 0 00-1 3.4v4M9 18c-4.5 2-5-2-7-2"
      title="GitHub"
    />
  ),
