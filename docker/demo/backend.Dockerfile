...
ARG REPO2REE_BUILD_REVISION=development
LABEL org.opencontainers.image.revision=$REPO2REE_BUILD_REVISION

ENV PYTHONDONTWRITEBYTECODE=1
ENV PYTHONUNBUFFERED=1
ENV REPO2REE_BUILD_REVISION=$REPO2REE_BUILD_REVISION
