"""Resolve executor/tool bundles injected by the Docker provider."""
...
def load_injection_bundle(exec_bundle_dir: str | None, tools_bundle_dir: str | None) -> InjectionBundle | None:
    """Resolve workbench-shipped bundle manifests into a mountable bundle."""
    ...
    return InjectionBundle(
        ...
        workbench_path=exec_manifest.get("workbench_path"),
