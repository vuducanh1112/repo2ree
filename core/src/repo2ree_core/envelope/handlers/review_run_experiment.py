...
:func:`repo2ree_core.reviews.compare_experiment_results`).
...
from repo2ree_core.reviews import (
    ...
    with_experiment,
    with_step,
    write_review_experiment_evidence,
    write_review_record,
)
...
def _author_verify_exit_code(author: RunExperimentReceipt) -> int | None:
    ...
    passed (see :func:`repo2ree_core.experiment.run.run_runnable`), and the
