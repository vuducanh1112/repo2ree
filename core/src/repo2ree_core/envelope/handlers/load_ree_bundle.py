...
from repo2ree_core.storage.extract import safe_extract_zip
from repo2ree_core.storage.layout import ReeLayout
from repo2ree_core.storage.store import ReeStore
from repo2ree_core.storage.workspace_ops import BundleLoadOutputs, restore_ree_bundle
...
def handle_load_ree_bundle(
    ...
    *,
    ...
    if is_canceled():
        log("system", "warn", "load_ree_bundle canceled before start")
