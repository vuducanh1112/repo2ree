"""Receipt schemas: what one executed run records about itself.
...
Schemas and the pure functions over them only. Where receipts live on disk is
``store``; what their digests mean against the current tree is ``consistency``.
"""
