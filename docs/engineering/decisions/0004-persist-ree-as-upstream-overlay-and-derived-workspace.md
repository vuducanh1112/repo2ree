...
- [Working-environment directory layout](../../ARCHITECTURE.md#working-environment-directory-layout)
- [State ownership](../../ARCHITECTURE.md#state-ownership-portable-aggregate-and-durable-tree)
- [Script inference: scan upstream](../script-inference.md#scan-upstream-never-the-workspace)
