...
export function createWorkspaceEditorState(params: {
...
export function normalizeUiChromePage(
  candidate: WorkspaceEditorPage,
  previous: WorkspaceEditorPage,
): WorkspaceEditorPage {
  return normalizeWorkspaceEditorPage(candidate, previous);
}
