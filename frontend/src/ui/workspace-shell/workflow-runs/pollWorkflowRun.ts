...
import { fetchWorkflowRun, fetchWorkflowRunLogs } from "../workspace-sync/remoteQueries";
...
function resolveRunTimestamp(run: WorkflowRunRecord, clock: WorkspaceShellClock): string {
