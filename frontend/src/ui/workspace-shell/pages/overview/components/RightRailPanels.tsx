...
import type { WorkspaceShellPage as WorkspaceShellPageType } from "../../../../../application/workspace-shell/WorkspaceShellPages";
import {
...
interface RightRailPanelsProps {
  ...
  level: number;
  onNavigate: (key: WorkspaceShellPageType) => void;
            ...
            <div ref={evaluateRef} style={panel({ overflow: "hidden" })}>
              ...
              <div style={S_OVERVIEW_META_FOOTER}>
                ...
                <button
                  ...
                  onClick={() =>
                    onNavigate?.(
                      isValidWorkspaceShellPage(workflowStep.key)
                        ? (workflowStep.key as WorkspaceShellPage)
                        : PAGE.OVERVIEW,
                    )
                  }
                  style={{
