...
export const FIELD_META: Record<string, FieldMeta> = {
  ...
  dependency_level: {
    ...
    desc: "See how completely dependencies are declared, pinned, and locked. Technically, Evaluate computes this axis from repository manifests and dependency metadata.",
    example: "Locked",
    format: "Auto-generated by Evaluate after a successful run.",
    howTo:
      "Run Evaluate to compute this value from detected dependency manifests and lock metadata.",
    tools: [],
  },
  environment_level: {
    label: "Environment Level",
    desc: "See whether the software environment is captured by a container or declarative system specification.",
    example: "Container",
    format: "Auto-generated by Evaluate after a successful run.",
    howTo:
      "Run Evaluate after adding source files such as Dockerfile, Containerfile, or Nix files.",
    tools: [],
  },
  machine_level: {
    label: "Machine Level",
    desc: "See whether the whole machine or OS image is captured with a VM artifact or definition.",
    example: "Virtual machine",
    format: "Auto-generated by Evaluate after a successful run.",
    howTo: "Run Evaluate after adding a VM image, Vagrantfile, or Packer definition.",
    tools: [],
  },
  runtime: {
    label: "Runtime",
