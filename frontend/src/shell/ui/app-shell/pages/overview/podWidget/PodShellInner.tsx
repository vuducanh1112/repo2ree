import { axisFraction, axisStandings } from "../../../../../../core/review/axes";
    ...
    <g>
      <defs>
        <radialGradient id={`${iId}Grad`} cx="38%" cy="30%" r="68%">
          ...
          <stop offset="62%" stopColor="#0369a1" stopOpacity="0.84" />
          <stop offset="100%" stopColor="#0c1a2e" stopOpacity="0.94" />
        </radialGradient>
