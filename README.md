...
```
cd existing_repo
git remote add origin https://gitlab.gwdg.de/nfdixcs/a2-reusable-execution-environment/repo2ree.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.gwdg.de/nfdixcs/a2-reusable-execution-environment/repo2ree/-/settings/integrations)
