...
def pin_dockerfile(dockerfile: str, cutoff_date: str, output_path: str):
    ...
    if _ouput_path.is_dir():
        pinned_dockerfile_path = _ouput_path / f"{_dockerfile.stem}_pinned{_dockerfile.suffix}"
    else:
